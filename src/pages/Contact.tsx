        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground">
              Ready to transform your business? Let's discuss how our expertise can drive your success forward.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-8">
              ...
              <Card className="border-0 shadow-card">
                <CardHeader>
                  <CardTitle>Why Choose DRH?</CardTitle>
                  <CardDescription>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-muted-foreground">27+ expert professionals</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full" />
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full" />
                    <span className="text-sm text-muted-foreground">Inclusive delivery model</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full" />
                    <span className="text-sm text-muted-foreground">Hybrid & remote support</span>
                  </div>
                </CardContent>
              </Card>
            </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select name="service">
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="finance">Finance & Tax Advisory</SelectItem>
